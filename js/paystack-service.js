...
class PaystackPaymentService {
  ...
  initiatePayment({
    ...
    if (typeof PaystackPop !== "undefined" && typeof PaystackPop.setup === "function") {
      try {
        ...
        console.warn("Paystack Inline failed to open iframe, falling back to simulated checkout:", err);
      }
    }
  ...
  simulateTestCheckout(orderData, onSuccess, onClose) {
    const isConfirmed = confirm(
      ...
      `Click OK to simulate a Successful Paystack Payment & generate your Official Digital Receipt!`
    );
